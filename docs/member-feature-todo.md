...
- 2026-05-17: 마이페이지를 서브 메인으로 전환하고, 내 정보/내 글/내 댓글 기능별 화면 구현을 시작합니다.
- 2026-05-17: `/my-page` 서브 메인, `/my-page/profile`, `/my-page/posts`, `/my-page/comments` 화면과 활동 목록 API를 추가했습니다.
- 2026-05-17: `npm run build`, `npm run lint` 통과. 비로그인 상태에서 마이페이지 보호 라우트가 로그인 화면으로 이동하는 것을 확인했습니다.
