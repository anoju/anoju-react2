    ...
    <div className="container" style={{ padding: '3rem 1.5rem' }}>
      <div style={{ 
        ...
        <div style={{ 
          ...
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-text)' }}>포근한 커뮤니티</h3>
          <p style={{ color: 'var(--color-text-dimmed)' }}>
            다양한 사람들과 따뜻한 이야기를 나누고 서로를 격려하세요.
          </p>
        </div>
        <div style={{ 
          padding: '2rem', 
          ...
          <h3 style={{ marginBottom: '1rem', color: 'var(--color-text)' }}>아름다운 갤러리</h3>
          <p style={{ color: 'var(--color-text-dimmed)' }}>
            소중한 순간들을 사진으로 남기고 함께 감상하는 공간입니다.
          </p>
        </div>
      </div>
    </div>
